...
# operator przypisania := (od Python 3.8.*)
...
Informacje o epratorach, rozbite niestety w wielu podrodziałach, znajdują się w dokumencie opisującym wbudowane typy danych języka Python: https://docs.python.org/3.13/library/stdtypes.html. Do tego dokumentu będziemy jeszcze wracać.

Bardziej szczegółowe informacje na temat priorytetów operatorów można znaleźć tu: https://docs.python.org/3.13/reference/expressions.html#operator-summary
...
> Dokumentacja: https://docs.python.org/3.13/library/stdtypes.html#str
