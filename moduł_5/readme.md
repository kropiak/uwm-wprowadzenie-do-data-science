...
Wygeneruj macierz (lista dwupoziomowa) losowych wartości (sprawdź pakiet **[random](https://docs.python.org/3.13/library/random.html)**)  o rozmiarach 4x4 i wykorzystując Python Comprehension zdefiniuj zmienną typu `list`, która będzie zawierała tylko elementy znajdujące się na przekątnej tej macierzy.
...
znaleźć w dokumentacji Pythona pod adresem https://docs.python.org/3.13/tutorial/datastructures.html#nested-list-comprehensions
...
Napisz funkcję, która wykorzystuje symbol ** dla określenia argumentów wejściowych. Funkcja przyjmuje argumenty w postaci: klucz to nazwa drużyny a wartość to ilość punktów, które drużyna zdobyła. Funkcja zlicza ile jest wszystkich punktów razem i zwraca tę wartość.
